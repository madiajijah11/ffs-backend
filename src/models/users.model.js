...
exports.createUser = async (data) => {
  try {
    const sql =
      'INSERT INTO users ("fullName", email, "phoneNumber", password, "groupUser", "companyName", "companyField", "picture") VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *';
    const values = [
      data.fullName,
      data.email,
      data.phoneNumber,
...
exports.getUserProfilEmployee = async (id) => {
  try {
    ...
    string_agg(DISTINCT(pfe."picture") , ', ') as "picture"
    from "users" as u
...
exports.updateUser = async (id, data) => {
  try {
    ...
    "picture" = COALESCE(NULLIF($9, ''), "picture")
...
exports.createUserEmployee = async (data) => {
  try {
    const sql =
      'INSERT INTO users ("fullName", email, "phoneNumber", password, "groupUser") VALUES ($1, $2, $3, $4, 1) RETURNING *';
